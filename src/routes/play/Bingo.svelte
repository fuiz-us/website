		...
		<NiceBackground>
			...
			>
				...
				{#if mostUpvotedUncrossedStatement !== undefined}
					<div>
						<h2 style:margin-bottom="4px" style:font-family="Poppins">{m.most_upvoted()}</h2>
				...
				{#if filteredUncrossedStatement.length}
					<div>
						<h2 style:margin-bottom="4px" style:font-family="Poppins">{m.uncrossed()}</h2>
						<div style:display="flex" style:flex-direction="column" style:gap="5px">
				...
				{#if crossedStatements.length}
					<div>
						<h2 style:margin-bottom="4px" style:font-family="Poppins">{m.crossed()}</h2>
						<div style:display="flex" style:flex-direction="column" style:gap="5px">
