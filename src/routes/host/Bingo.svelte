	...
	<NiceBackground>
		...
		>
			{#if mostUpvotedUncrossedStatement !== undefined}
				<div>
					<h2 style:margin-bottom="0.2em" style:font-family="Poppins">{m.most_upvoted()}</h2>
			...
			{#if filteredUncrossedStatement.length}
				<div>
					<h2 style:margin-bottom="0.2em" style:font-family="Poppins">{m.uncrossed()}</h2>
			...
			{#if crossed_statements.length}
				<div>
					<h2 style:margin-bottom="0.2em" style:font-family="Poppins">{m.crossed()}</h2>
					<div style:display="flex" style:flex-direction="column" style:gap="0.2em">
