...
<div
	...
	style:box-shadow="0 2px 2px #00000040{topShadow ? ', 0 -2px 2px #00000040' : ''}"
	style:text-align="center"
>
	<div style:flex="1" style:font-size={fontSize} style:font-weight="bold">
		{questionText}
	</div>
	{#if show_next}
